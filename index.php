		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p>
						<a href="gallery.php" class="btn btn-primary white">Amusment</a>
						<a href="gallery.php" class="btn btn-primary solid">Water</a>
						<a href="gallery.php" class="btn btn-primary white">Resort</a>
					</p>
				</div>
			</div>
		</div><!-- Container end -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 heading">
					...
					<h2 class="title">Meet with our Team <span class="title-desc"></span></h2>
				</div>
			</div><!-- Title row end -->
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="team wow slideInLeft">
						...
						<div class="team-content">
							<h3>Jharana Savjani</h3>
							<p>Chilling Point C.E.O.</p>
				...
				<div class="col-md-3 col-sm-6">
					<div class="team animate wow slideInRight">
						...
						<div class="team-content">
							<h3>Hitanshi Chauhan</h3>
							<p>Amusment Park Manager</p>
